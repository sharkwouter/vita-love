...
bool alignedMalloc(void **mem, size_t size, size_t alignment)
{
	...
	*mem = _aligned_malloc(size, alignment);
	return *mem != nullptr;
#else
  // Source of this bullshit is: https://stackoverflow.com/questions/38088732/explanation-to-aligned-malloc-implementation
  void* p1;
  ...
  mem = (void**)(((size_t)(p1) + offset) & ~(alignment - 1));
	return *mem != nullptr;
#endif
}
